        ...
        <div className='flex justify-center items-center min-h-[80vh] py-8 bg-gradient-to-br from-white via-blue-50 to-sky-100'>
            <div className='rounded-xl p-6 md:p-8 bg-white shadow-lg border border-gray-200 max-w-md w-full'>
                <div className='text-center mb-4'>
                    ...
                    <h2 className='font-bold text-xl text-gray-800'>Welcome Back!</h2>
                    <p className='text-gray-500 text-xs mt-1'>Sign in to continue to Dragon News</p>
                </div>
                ...
                <form onSubmit={handleSubmit(handleLogin)} className="space-y-3">
                    ...
                    <button 
                        type='submit' 
                        className='w-full cursor-pointer bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white py-2 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md text-sm'
                    >
                        Sign In
                    </button>
                </form>
